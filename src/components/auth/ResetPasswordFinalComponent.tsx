...
const ResetPasswordFinalComponent: React.FC<ResetPasswordFinalComponentProps> = ({onResetPassword}) => {
  const {
    register,
    formState: { errors },
    handleSubmit,
  ...
  return (
      <form className="p-8 pt-4 w-auto min-w-[24rem] " onSubmit={handleSubmit(onSubmit)}>
        {apiErrors && (
