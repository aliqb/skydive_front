...
import { AddFlightRequest } from "../../../models/skyDiveEvents.models";
                ...
                <div key={field.id} className="w-full flex  mb-3">
                  ...
                  <div className="w-4/12 px-5 pl-1">
                    <SDTextInput
                      ...
                      invalid={!!formErrors?.ticketTypes?.[index]?.qty?.message}
                    />
                  ...
                  <div className="w-4/12 xs:w-3/12 flex  pl-5 pr-2 justify-between">
                    ...
                    {fields.length - 1 === index && (
                      <SDButton
                        ...
                        onClick={addTicket}
                        // disabled={fields.length === typesResponse.content.length}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
